...
public class PastOrdersFragment extends Fragment {
    ...
    RecyclerView recyclerview_OrderOrders;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        startAnim();
        recyclerview_OrderOrders = view.findViewById(R.id.recyclerview_CurrentOrders);
        loadOrders();
        return view;
    }
...
//        RequestBody parameter = RequestBody.create(MediaType.parse("text/plain"),product_Category);
        Call<OrderListResponseModel> call = service.getPastOrders(user_Id);
...
//                        Toast.makeText(getActivity(), "No Order Found", Toast.LENGTH_LONG).show();
                        ...
                        showOrders(recyclerview_OrderOrders, dataList);
                    }
                }
                else if (status == 400){
                    stopAnim();
